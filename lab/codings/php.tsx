...
<h1 className="font-display">PHP Interpreter</h1>
<Link to="/lab/langs" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.6rem 1.2rem', marginTop: '1rem', background: 'linear-gradient(135deg,#e5191e,#e5191e)', color: '#ffffff', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '600', letterSpacing: '0.05em', borderRadius: '0.5rem', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 6px 18px rgba(99,102,241,0.35)', transition: 'all 0.25s ease' }}>← Back to Lab</Link>
</div>
...
<button className="button button-lg button-default" id="runBtn"><i className="fas fa-play"></i> Execute Code</button>
<button className="button button-lg button-secondary" id="clearBtn"><i className="fas fa-eraser"></i> Clear Editor</button>
<button className="button button-lg button-ghost" id="saveBtn"><i className="fas fa-download"></i> Save Script</button>
</div>
</div>
</div>
</div>
