        ...
        <div className="desktop-main">
            <div className="card interpreter-header">
                <div className="interpreter-hero">
                    <h1 className="font-display">Python Interpreter</h1>
                    <a href="../langs"
                    style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.6rem 1.2rem', marginTop: '1rem', background: 'linear-gradient(135deg,#e5191e,#e5191e)', color: '#ffffff', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '600', letterSpacing: '0.05em', borderRadius: '0.5rem', border: '1px solid rgba(255,255,255,0.15)', boxShadow: '0 6px 18px rgba(99,102,241,0.35)', transition: 'all 0.25s ease' }}
            ...
            <div className="controls-section">
                <div className="controls-grid">
                    <button onClick="runPython()" className="button button-lg button-default" id="runBtn">
                        <i className="fas fa-play"></i> Execute Code
                    </button>
                    <button onClick="clearCode()" className="button button-lg button-secondary">
                        <i className="fas fa-eraser"></i> Clear Editor
                    </button>
                    <button onClick="resetInterpreter()" className="button button-lg button-ghost">
                        <i className="fas fa-redo"></i> Reset Environment
                    </button>
                    <button onClick="saveToFile()" className="button button-lg button-ghost">
