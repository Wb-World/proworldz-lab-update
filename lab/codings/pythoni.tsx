        ...
        <div className="desktop-main">
            ...
            <div className="controls-section">
                <div className="controls-grid">
                    <button className="button button-lg button-default" id="runBtn">
                        <i className="fas fa-play"></i> Execute Code
                    </button>
                    <button className="button button-lg button-secondary" id="clearBtn">
                        <i className="fas fa-eraser"></i> Clear Editor
                    </button>
                    <button className="button button-lg button-ghost" id="resetBtn">
                        <i className="fas fa-redo"></i> Reset Environment
                    </button>
                    <button className="button button-lg button-ghost" id="saveBtn">
