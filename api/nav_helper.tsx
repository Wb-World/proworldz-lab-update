...
<div className="nav-section">
        <a href="dashboard" className="nav-item {/* PHP code removed */}">
        ...
        <a href="lab" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none">
        ...
        <a href="tasks" className="nav-item {/* PHP code removed */}">
        ...
        <a href="ourcourse" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor">
        ...
        <a href="assignment" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none" stroke="currentColor">
        ...
        <a href="maintanance" className="nav-item disabled {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none">
        ...
        <a href="leaderboard" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none">
        ...
        <a href="teams" className="nav-item {/* PHP code removed */}">
        ...
        <a href="tournament" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <a href="contactus" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none">
        ...
        <a href="eaglone_shop" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none">
        ...
        <a href="settings" className="nav-item {/* PHP code removed */}">
            <svg className="nav-icon" viewBox="0 0 20 20" fill="none">
